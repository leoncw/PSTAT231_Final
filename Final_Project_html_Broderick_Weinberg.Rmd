...
The mean absolute error of our random forest regression model is `r RF.MAE` which is an relativey okay mean absolute error, but mediocre in an absolute sense, as is discussed in the results section.
